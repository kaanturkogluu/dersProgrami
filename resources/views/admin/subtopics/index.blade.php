...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('admin.subtopics.create') }}" class="btn btn-primary">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100 category-card" style="cursor: pointer; transition: all 0.3s ease;" 
                 onclick="window.location.href='{{ route('admin.subtopics.category', $category) }}'">
                    ...
                    <div class="row text-center mb-3">
                        <div class="col-6">
                            <div class="stats-item">
                                <div class="stats-number text-primary">{{ $category->courses->flatMap->topics->flatMap->subtopics->count() }}</div>
                                <div class="stats-label">Toplam Alt Konu</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="stats-item">
                                <div class="stats-number text-success">{{ $category->courses->sum('topics_count') }}</div>
